    ...
    const fetchBidsForItem = async (itemId) => {
        try {
            ...
            for (let i = 0; i < response.data.length; i++) {
                const bidderInfo = await profileAPI.getBidderProfile(
                    response.data[i].bidderId
                );
                ...
                <div className="bids-section">
                    {selectedItem ? (
                        <>
                            ...
                            {bidsLoading ? (
                                ...
                                <div className="empty-bids">
                                    ...
                                    <h4>No Bids Yet</h4>
                                    <p>
                                        This item hasn't received any bids yet.
                                    </p>
                                    <p>
                                        Share your listing to attract more
                                        buyers!
                                    </p>
                                </div>
                            ) : (
                              ...
                              'At asking price'
                                            ...
                                            {bid.status === "accepted" && (
                                                <div className="bid-success">
                                                    ✅ Bid accepted! Contact the
                                                    buyer to complete the
                                                    transaction.
                                                </div>
                                            )}
                        ...
                        <div className="select-item-prompt">
                            ...
                            <p>
                                You'll see all offers and can accept or reject
                                them
                            </p>
                        </div>
                    )}
